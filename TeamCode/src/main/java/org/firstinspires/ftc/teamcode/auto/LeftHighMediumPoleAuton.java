...
@Autonomous(name = "Left High Medium")
public class LeftHighMediumPoleAuton extends LinearOpMode
{
    @Override
...
//                .setOdometryWheelProperties(8192, 70, -233, -186)
        ...
        Pipeline pipeline = new Pipeline.Builder(manager)
                ...
                .addAction(new SetArmAction(manager,maxLiftHeight - 700))
                .addAction(new DelayAction(manager, 200))
                .addLinearPath(PrecisionMode.HIGH, profile, new Position(230, 1315, Math.PI, 1.4))
                .addAction(new FullStopAction(manager))
                .addAction(new SetArmAction(manager, maxLiftHeight - 1000))
                .addAction(new DelayAction(manager, 200))
                .addAction(toggleClawAction)
                ...
                .addAction(new SetArmAction(manager,maxLiftHeight - 700))
                .addAction(new DelayAction(manager, 200))
                .addLinearPath(PrecisionMode.HIGH, profile, new Position(245, 1325, Math.PI, 1.4))
                .addAction(new FullStopAction(manager))
                .addAction(new SetArmAction(manager, maxLiftHeight - 1000))
                .addAction(new DelayAction(manager, 200))
                .addAction(toggleClawAction)
                ...
                .addAction(new SetArmAction(manager,maxLiftHeight - 700))
                .addAction(new DelayAction(manager, 200))
                .addLinearPath(PrecisionMode.HIGH, profile, new Position(260, 1335, Math.PI, 1.4))
                .addAction(new FullStopAction(manager))
                .addAction(new SetArmAction(manager, maxLiftHeight - 1000))
                .addAction(new DelayAction(manager, 200))
                .addAction(toggleClawAction)
